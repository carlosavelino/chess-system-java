...
public class ChessMatch {
	...
	private ChessPiece enPassantVulnerble;
	...
	public ChessPiece getEnPassantVulnerble() {
	...
	private void undoMove(Position source, Position target, Piece capturedPiece) {
		...
		// #specialmove en passant
		if (p instanceof Pawn) {
			if (source.getColumn() != target.getColumn() && capturedPiece == enPassantVulnerble) {
